...
if($post->ID) {
	if($post->post_parent) { // page is a child
		...
		if($parent->post_parent) { // if page is a grandchild
			...
			if($grandparent->post_parent) { // if page is a greatgrandchild
				...
				if($greatgrandparent->post_parent) { // if page is a greatgreatgrandchild
					...
					if($greatgreatgrandparent->post_parent) { // if page is a greatgreatgreatgrandchild
						...
						$children = wp_list_pages('sort_column=menu_order&title_li=&child_of='.$greatgreatgrandparent->post_parent.'&depth=1&echo=0');
						$sidenav = wp_list_pages('sort_column=menu_order&title_li=&child_of='.$greatgrandparent->post_parent.'&echo=0');
					}
					else {
						...
						$children = wp_list_pages('sort_column=menu_order&title_li=&child_of='.$greatgrandparent->post_parent.'&depth=1&echo=0');
						$sidenav = wp_list_pages('sort_column=menu_order&title_li=&child_of='.$grandparent->post_parent.'&echo=0');
					}
				}
				else {
					...
					$children = wp_list_pages('sort_column=menu_order&title_li=&child_of='.$grandparent->post_parent.'&depth=1&echo=0');
					$sidenav = wp_list_pages('sort_column=menu_order&title_li=&child_of='.$parent->post_parent.'&echo=0');
				}	
			}
				...
				$children = wp_list_pages('sort_column=menu_order&title_li=&child_of='.$parent->post_parent.'&depth=1&echo=0');
				$sidenav = wp_list_pages('sort_column=menu_order&title_li=&child_of='.$post->post_parent.'&echo=0');
			}
		}
			...
			$sidenav = wp_list_pages('sort_column=menu_order&title_li=&child_of='.$post->ID.'&echo=0');
		}
	}
	else {
